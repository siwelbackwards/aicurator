-- Complete Admin Setup: Migration + Admin Approval
-- Copy and paste this entire script into your Supabase SQL Editor

-- ============================================
-- PART 1: APPLY USER APPROVAL SYSTEM MIGRATION
-- ============================================
...
-- ============================================
-- PART 2: APPROVE ALL ADMIN USERS
-- ============================================
...
WHERE user_status IS NULL
  ...
  AND role != 'admin'; -- Don't override admin approvals
...
-- Verify admin users are approved
SELECT
    id,
    email,
    role,
...
UNION ALL
SELECT
    'Pending users: ' || COUNT(*) as summary
FROM public.profiles
